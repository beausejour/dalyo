package com.penbase.dma.xml;
/*
 	Contains all the values of Dalyo script xml stream's attribute
 */
public class XmlScriptAttribute {		
	//Functions
	...
	//Namespace
	public static final String NAMESPACE_FORM = "form";
	...
	public static final String PARAMETER_FACELESS = "faceless";
	
	//Constants
	public static final String CONST_FALSE = "FALSE";
	public static final String CONST_NULL = "FALSE";
	public static final String CONST_TRUE = "FALSE";
}
