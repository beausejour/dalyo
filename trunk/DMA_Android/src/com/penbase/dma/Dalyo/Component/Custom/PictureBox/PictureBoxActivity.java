 ...
 */
public class PictureBoxActivity extends Activity implements
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_CAMERA:
			// take picture
			// play sound
			MediaPlayer mp = MediaPlayer.create(PictureBoxActivity.this,
					R.raw.camera_click);
			mp.start();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(Menu.NONE, 0, Menu.NONE, R.string.save).setIcon(
				android.R.drawable.ic_menu_save);
		menu.add(Menu.NONE, 1, Menu.NONE, R.string.cancel).setIcon(
		...
		case 0:
			...
			if (mPhotoBytes != null) {
				...
				filePath.append(ApplicationView.getUsername()).append(
						"/");
				filePath.append(ApplicationView.getApplicationId())
						.append("/");
				...
				((DalyoPictureBox) ApplicationView.getComponents().get(
						mId).getDalyoComponent())
						.setPhotoPath(filePath.toString());
				PictureBoxActivity.this.finish();
