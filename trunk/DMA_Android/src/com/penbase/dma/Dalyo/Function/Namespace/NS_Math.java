...
public class NS_Math {
	...
	public static int Ceil(Element element) {
		...
		return Double.valueOf(Math.ceil(Double.valueOf(value.toString()))).intValue();
	}
	...
	public static int Floor(Element element) {
		...
		return Double.valueOf(Math.floor(Double.valueOf(value.toString()))).intValue();
	}
	...
	public static String Format(Element element) {
		...
		boolean hasThousandsSep = Boolean.valueOf(Function.getValue(element, ScriptTag.PARAMETER, ScriptAttribute.PARAMETER_NAME_THOUSANDSSEP, ScriptAttribute.PARAMETER_TYPE_BOOLEAN).toString());
		if (decimal != null) {
	...
	public static Object Percentage(Element element) {
		Object value = Function.getValue(element, ScriptTag.PARAMETER, ScriptAttribute.PARAMETER_NAME_VALUE, ScriptAttribute.PARAMETER_TYPE_NUMERIC);
		Object percent = Function.getValue(element, ScriptTag.PARAMETER, ScriptAttribute.PARAMETER_NAME_PERCENT, ScriptAttribute.PARAMETER_TYPE_NUMERIC);
		return new BigDecimal(value.toString()).multiply(new BigDecimal(percent.toString()).divide(new BigDecimal("100")));
	}
