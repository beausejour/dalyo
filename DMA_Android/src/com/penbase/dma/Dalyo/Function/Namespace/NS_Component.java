...
public class NS_Component {
	...
	public static void SetEnabled(Element element) {
		...
		Object state = Function.getValue(element, ScriptTag.PARAMETER,
				ScriptAttribute.PARAMETER_NAME_ENABLE,
	...
	public static void SetText(Element element) {
		String componentId = Function.getValue(element, ScriptTag.PARAMETER,
				ScriptAttribute.COMPONENT, ScriptAttribute.COMPONENT)
				.toString();
		if (Function.getValue(element, ScriptTag.PARAMETER,
				ScriptAttribute.PARAMETER_NAME_TEXT, ScriptAttribute.STRING) != null) {
			String text = Function
					.getValue(element, ScriptTag.PARAMETER,
							ScriptAttribute.PARAMETER_NAME_TEXT,
